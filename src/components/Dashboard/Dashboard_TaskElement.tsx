...
function TaskElement({ task }: TaskElementProps) {
  ...
  const cardStyleDetails = `flex flex-col w-full mx-auto p-2 content-center min-h-24 border-solid[1px] hover:drop-shadow-lg dark:text-jet-600 dark:brightness-[0.6] ${
      ...
      <CardContent className="flex flex-col max-h-full space-y-2 w-full content-center ">
        ...
        <div className="flex btns-container w-full space-x-3 justify-end">
          <Dialog open={dialogIsOpen} onOpenChange={setDialogIsOpen}>
            ...
            <DialogContent className="sm:max-w-[425px] bg-jet-50 border-jet-200 dark:bg-jet-700 dark:text-jet-50">
              <DialogHeader>
          ...
          <Dialog>
            ...
            <DialogContent className="bg-jet-50 border-jet-200 dark:bg-jet-500 dark:text-jet-50">
              <DialogHeader>
                <DialogTitle>
